...
class VoiceStream(BoxLayout):
    ...
    def process_audio_data(self, audio_data):
        ...
        self.plot.points = [(i, j / 32767.0) for i, j in enumerate(audio_data)]
        
        # Reshape audio_data for model prediction - ensure the shape is correct
        # Assuming the model expects an input shape of (1, 1024) for this example
        ...
        if prediction[0][0] > 0.5:  # Adjust based on the model's output shape
